      ...
      <div class="col-lg-12 col-md-12 d-flex justify-content-center">
        ...
        <div class="col-lg-6 col-md-6 shadow p-4 mt-2 mb-4 bg-white login-form">
          ...
          if(isset($_SESSION['Choice'])) {
            if($_SESSION['Choice'] == 10) {
              echo '<div class="alert alert-danger">
              <strong><i class="fa fa-times" aria-hidden="true"></i></strong> Password and Confirm Password are different
              </div>';
            }
          }
           ?>
          <form action="Password.php" method="POST">
            ...
            <div class="form-group input-group">
              ...
              <input type="password" class="form-control" id="password" placeholder="Enter the New Password" name="password1">
            </div>
            <div class="form-group input-group">
              <div class="input-group-prepend">
                <span class="input-group-text"><i class="fa fa-key" aria-hidden="true"></i></span>
              </div>
              <input type="password" class="form-control" id="password" placeholder="Confirm New Password" name="password2">
            </div>
