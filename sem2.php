    ...
    <div class="container">
      ...
      <div class="row m-2 d-flex justify-content-center text-center">
        <div class="col-lg-3 col-md-3 m-2 border p-4 mb-4 sem d-flex align-items-center justify-content-center">
          <a href="#" style="text-decoration:none;">
            <i class="fa fa-sort-numeric-asc fa-4x" aria-hidden="true" style="color:#ffa0ff"></i>
           <h4 style="color:black">Mathematics II</h4>
          </a>
        </div>
        <div class="col-lg-3 col-md-3 m-2 border p-4 mb-4 sem d-flex align-items-center justify-content-center">
          <a href="#" style="text-decoration:none;">
            <img src="icon/people.png" alt="" style="width:80px;height:80px;">
           <h4 style="color:black">Managerial Economics</h4>
          </a>
        </div>
        <div class="col-lg-3 col-md-3 m-2 border p-4 mb-4 sem d-flex align-items-center justify-content-center">
          <a href="#" style="text-decoration:none;">
            <img src="icon/c.png" alt="" style="width:80px;height:80px;">
      ...
      <div class="row m-2 d-flex justify-content-center text-center">
        <div class="col-lg-4 col-md-4 m-2 border p-4 mb-4 sem d-flex align-items-center justify-content-center">
          <a href="#" style="text-decoration:none;">
            <img src="icon/python.png" alt="" style="width:80px;height:80px;">
           <h4 style="color:black">Digital Electronics</h4>
          </a>
        </div>
        <div class="col-lg-5 col-md-5 m-2 ml-4 border p-4 mb-4 sem d-flex align-items-center justify-content-center sub">
          <a href="#" style="text-decoration:none;">
            <img src="icon/jsp.png" alt="" style="width:80px;height:80px;">
           <h4 style="color:black">Discrete Mathematics</h4>
          </a>
        </div>
      </div>
    </div>
